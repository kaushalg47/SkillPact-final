...
const PublicResumeScreen = () => {
  ...
  return (
    <div className="container py-4">
      ...
      <div className="mt-4">
        <h5 className="mb-3">Accepted Jobs</h5>
        {applications.filter(application => application.status === "accepted").length > 0 ? (
          <div className="row">
          ...
          <p className="text-muted text-center">No accepted job applications available</p>
        )}
      </div>
    </div>
  );
...
export default PublicResumeScreen;
